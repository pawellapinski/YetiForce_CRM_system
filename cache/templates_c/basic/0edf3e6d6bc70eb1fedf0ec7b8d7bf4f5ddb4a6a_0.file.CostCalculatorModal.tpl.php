<?php
/* Smarty version 4.2.0, created on 2025-03-23 11:23:00
  from 'C:\xampp7.4\htdocs\crm\layouts\basic\modules\Cars\CostCalculatorModal.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_67dfe104a4c262_16569532',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0edf3e6d6bc70eb1fedf0ec7b8d7bf4f5ddb4a6a' => 
    array (
      0 => 'C:\\xampp7.4\\htdocs\\crm\\layouts\\basic\\modules\\Cars\\CostCalculatorModal.tpl',
      1 => 1742725308,
      2 => 'file',
    ),
  ),
...
function content_67dfe104a4c262_16569532 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="modal-header"><h5 class="modal-title"><span class="fas fa-calculator mr-1"></span>Kalkulator kosztów</h5><button type="button" class="close" data-dismiss="modal" aria-label="Zamknij"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"><form class="form-horizontal" id="costCalculatorForm"><input type="hidden" name="record" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
" /><div class="form-group row"><label class="col-sm-4 col-form-label">Data początkowa:</label><div class="col-sm-8"><div class="input-group date"><input type="text" name="start_date" class="dateField form-control" data-date-format="yyyy-mm-dd" /><div class="input-group-append"><span class="input-group-text"><span class="fas fa-calendar-alt"></span></span></div></div></div></div><div class="form-group row"><label class="col-sm-4 col-form-label">Data końcowa:</label><div class="col-sm-8"><div class="input-group date"><input type="text" name="end_date" class="dateField form-control" data-date-format="yyyy-mm-dd" /><div class="input-group-append"><span class="input-group-text"><span class="fas fa-calendar-alt"></span></span></div></div></div></div></form></div><div class="modal-footer"><button class="btn btn-success" type="button" name="calculateButton" id="calculateButton"><span class="fas fa-calculator mr-1"></span>Oblicz</button><button class="btn btn-danger" type="reset" data-dismiss="modal"><span class="fas fa-times mr-1"></span>Anuluj</button></div><?php echo '<script'; ?>
